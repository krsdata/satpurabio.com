  ...
  <h5> <strong> Composition: </strong> 70% silica</h5>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-10">
      <input type="email" class="form-control" id="name" placeholder="Enter Email" name="useremail" required>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="Phone">Phone No.:</label>
      <div class="col-sm-10">
      <input type="text" class="form-control" id="name" placeholder="Enter Phone #" name="userephone" required>
      </div>
    </div>
    <div class="form-group">
